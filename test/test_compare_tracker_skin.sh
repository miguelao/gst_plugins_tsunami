...
queue max-size-buffers=1 ! identity sleep-time=5000 ! tee name=t0 \
...
textoverlay text=\"facetracker + SKIN (blue-face detected, red-no face detected)\" halignment=0 valignment=2 shaded-background=true ! ffmpegcolorspace ! vm.sink_2 \
\
t0. !  ffmpegcolorspace2 ! \
skin display=true method=1 !  ffmpegcolorspace2 ! \
textoverlay text=\"skin colour only\" halignment=0 valignment=2 shaded-background=true ! \
ffmpegcolorspace2 ! vm.sink_3 \
\
t0. !  ffmpegcolorspace2 ! \
 facetracker  profile=\"./cascades/haar.txt\" showskin=true enableskin=true !  ffmpegcolorspace2 ! \
